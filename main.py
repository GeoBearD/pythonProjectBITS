...
def phone_numbers_statistic():                           # Статистика по одинаковым номерам в консоли в виде таблицы
...
def surname_statistic():                                 # Статистика по однофамильцам в консоли в виде таблицы
    encoding = detect_encoding(filename)
    with open(filename, 'r', encoding=encoding) as f:
        surnames = []
        for line in f:
...
def dob_statistic():                                    # Статистика по годам рождения в консоли в виде таблицы
    encoding = detect_encoding(filename)
    with open(filename, 'r', encoding=encoding) as f:
        years = {}
        for line in f:
